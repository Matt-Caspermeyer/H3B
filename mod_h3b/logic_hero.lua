...
--  local rune_pal = { "1,4,2", "2,4,2", "2,4,2", "3,4,0", "0,4,3", "2,5,1" } -- 7, 8, 8, 7, 7, 8: 10, 25, 10 (22%, 56%, 22%)
  local rune_pal = { "1,4,2", "1,4,2", "2,4,1", "3,4,1", "2,3,3", "2,4,2" } -- 7, 7, 7, 8, 8, 8: 11, 23, 11 (24.4%, 51.2%, 24.4%)
  local rune_mag = { "1,2,4", "2,1,4", "0,1,6", "1,3,4", "1,3,4", "1,2,5" } -- 7, 7, 7, 8, 8, 8: 6, 12, 27 (13.3%, 26.7%, 60%)
