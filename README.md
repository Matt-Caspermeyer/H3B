...
***NOTE: I'm not developing this MOD any more and so this is for historical purposes***
---------------------------------------------------------------------------------------
...
1. This mod was developed using the Gamer's Gate V1.7 (Build 35,396) version of King's Bounty: The Legend.
    ...
    1. For example, I also have the GoG version of the game and it is V1.7 (Build 35,234) and:</li>
        ...
        1. Please email the company you got Build 35,234 from and request they update to Build 35,396.
...
3. This mod uses the English localizations using both the "eng_" and "en_" prefixes for the localization files.
    1. As mentioned above, only one of those files is needed to play the game.
    1. Other versions may have other prefixes and so you may be able to get this mod to work with your localization version by changing the prefixes of the *.LNG localization files.
        ...
        1. Simply rename *.kfs to *.zip and extract files if you wish to attempt this.
        1. Currently, you're on your own if you want to get it to work with a different localization, but if you'd like to help with localizations in your country then please let me know.
...
2. If the game appears to lock up, ALT-TAB back to Windows to see if there is a pop-up.
    ...
    1. After you click OK, the game will most likely crash exit to Windows.
    1. If the game does not crash after you click OK, it is highly recommended to quit your game rather than continue since behavior may be strange.
...
4. If the game locks up when you cursor over a child or item, there is a misspelling in one of the templates:
    ...
    1. Contact me and let me know which child it is and I'll correct the error
    1. I hope we've found all these errors!
5. Try to load from a save game and see if it still crashes in the same spot. If it crashes in the same spot, the only hope I have of resolving the issue is for:
    ...
    1. Provide me the exact steps to repeat the crash.
    1. Without these, my chance of resolving this issue is probably very slim.
...
1. I've had crashes with a failure to allocate more memory a couple of times.
    ...
    1. Let me know if you see this problem, but currently I have no idea how to resolve it (I probably would need 1CC or Katauri Interactive's help with this one).
    1. This problem seems to exhibit itself after you've been playing a long gaming session (it seems like I run into this after playing for several hours).
...
1. Damage causing effects (i.e. burning and poison):
    ...
    1. I worked and worked trying to fix this bug, but to no avail.
        ...
        1. As such, I don't know how to fix this bug, but if you have any ideas then please let me know!
...
1. As this version of the mod is in a beta state, there are still changes that are being done; however:
    ...
    1. Every change has been checked at least once, but I'm in the quality assurance phase rechecking the code.
    1. I'm currently play testing the game with a Paladin.
2. At this stage, changes should not require you to restart your game - simply install the new files and continue playing.
    ...
    1. New features can still be added, but only if they are really good ideas!
...
2. I've added comments where warranted to the areas in the game that I've changed, but not everywhere.
    ...
    1. Certain comments have the word "HACK" where I did not know how to do it a better way - once again if you know a better way to implement this feature then please let me know!
...
4. I've made common functions for dealing with redundant code.
    ...
    1. I've replaced most of the redundant code in the *.LUA functions I've edited to reduce error and provide code consistency.
...
4. All of my effort is being freely distributed to the public domain.
    ...
    1. Feel free to use this code base as a starting point for your own mod!
